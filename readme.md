...
If you are looking for a simple HTML/vanilla JavaScript version, check [here](https://github.com/smiley717/chatgpt-web-application)
...
```sh
git clone https://github.com/smiley717/chatgpt-web-application
```
...
```sh
yarn | yarn install #install the backend dependencies
```
